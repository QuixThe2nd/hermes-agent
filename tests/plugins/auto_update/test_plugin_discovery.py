...
def _stub_systemd_side_effects(monkeypatch, unit_dir: Path):
    ...
    monkeypatch.setattr(
        "plugins.auto_update.systemd.detect_install_scope", lambda: scope
    )
    monkeypatch.setattr(
        "plugins.auto_update.lifecycle.platform_supported", lambda: True
    )
    monkeypatch.setattr(
        "plugins.auto_update.systemd.default_systemctl_runner",
...
def test_bundled_default_enabled_loads(hermes_home, monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "plugins.auto_update.lifecycle.reconcile_scheduler_on_load",
